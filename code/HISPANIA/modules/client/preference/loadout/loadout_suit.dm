...
/datum/gear/suit/labcoat_pulse
	display_name = "pulse jacket, Medical"
	path = /obj/item/clothing/suit/storage/labcoat/fluff/pulsecoat
...
/datum/gear/suit/roboticist_lab
	display_name = "roboticist labcoat, roboticist"
